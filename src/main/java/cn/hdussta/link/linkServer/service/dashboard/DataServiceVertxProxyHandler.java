    ...
    try{
      ...
      switch (action) {
        case "listData": {
          ...
          try {
            service.listData((java.lang.String)ApiHandlerUtils.searchInJson(params, "deviceId"),
        ...
        case "countData": {
          ...
          JsonObject params = context.getParams();
          try {
            service.countData((java.lang.String)ApiHandlerUtils.searchInJson(params, "deviceId"),
                            ApiHandlerUtils.searchOptionalLongInJson(params, "sensorId").map(Long::intValue).orElse(null),
                            context,
                            res -> {
                            if (res.failed()) {
