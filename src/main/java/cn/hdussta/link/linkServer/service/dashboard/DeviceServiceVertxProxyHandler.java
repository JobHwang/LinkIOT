    ...
    try{
      ...
      switch (action) {
        ...
        case "putDevice": {
          ...
          JsonObject params = context.getParams();
          try {
            service.putDevice(ApiHandlerUtils.searchOptionalJsonObjectInJson(params, "body").map(j -> new cn.hdussta.link.linkServer.dashboard.bean.PutDeviceBody(j)).orElse(null),
                            context,
                            res -> {
                            if (res.failed()) {
                              if (res.cause() instanceof ServiceException) {
        ...
        case "postDevice": {
          ...
          JsonObject params = context.getParams();
          try {
            service.postDevice(ApiHandlerUtils.searchOptionalJsonObjectInJson(params, "body").map(j -> new cn.hdussta.link.linkServer.dashboard.bean.PostDeviceBody(j)).orElse(null),
                            context,
                            res -> {
                            if (res.failed()) {
                              if (res.cause() instanceof ServiceException) {
        ...
        case "deleteDevice": {
          ...
          JsonObject params = context.getParams();
          try {
            service.deleteDevice((java.lang.String)ApiHandlerUtils.searchInJson(params, "deviceId"),
                            context,
                            res -> {
                            if (res.failed()) {
                              if (res.cause() instanceof ServiceException) {
        ...
        case "getState": {
          ...
          JsonObject params = context.getParams();
          try {
            service.getState((java.lang.String)ApiHandlerUtils.searchInJson(params, "deviceId"),
                            context,
                            res -> {
                            if (res.failed()) {
                              if (res.cause() instanceof ServiceException) {
        ...
        case "postState": {
          ...
          JsonObject params = context.getParams();
          try {
            service.postState((java.lang.String)ApiHandlerUtils.searchInJson(params, "deviceId"),
                            (io.vertx.core.json.JsonObject)ApiHandlerUtils.searchInJson(params, "body"),
                            context,
                            res -> {
                            if (res.failed()) {
                              if (res.cause() instanceof ServiceException) {
        ...
        case "forceClose": {
          ...
          JsonObject params = context.getParams();
          try {
            service.forceClose((java.lang.String)ApiHandlerUtils.searchInJson(params, "deviceId"),
                            context,
                            res -> {
                            if (res.failed()) {
                              if (res.cause() instanceof ServiceException) {
